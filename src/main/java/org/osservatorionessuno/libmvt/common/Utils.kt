...
object Utils {
    ...
    // The following list is taken from AndroidQF.
    // Mutable so tests can temporarily register fixture cert fingerprints.
    @JvmField
    val VALID_CERTIFICATES: MutableSet<String> = mutableSetOf(
